...
hidemeta: false
comments: false
summary: "Windows machine which has webDAV which allow us to send a reverse shell to gain RCE. We have privesc thanks to the SeImpersonatePrivilege which can be exploited with tools like churrasco or JuicyPotato."
